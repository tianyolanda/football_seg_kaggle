...
if not os.path.exists(checkpoints_save_dir):
    ...
    os.mkdir(checkpoints_save_dir+'logs/')
else:
...
tensorboard = TensorBoard(log_dir= checkpoints_save_dir+'logs/{}'.format(time())) 
